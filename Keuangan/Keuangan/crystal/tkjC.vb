...
Public Class tkjC
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Pimpinan() As CrystalDecisions.[Shared].IParameterField
        Get
